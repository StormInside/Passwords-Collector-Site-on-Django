"""pass_collector URL Configuration
...
urlpatterns = [
    ...
    path('', include('pass_collector_app.urls')),
    # path('loged/', include('pass_collector_app.urls')),

    # path('settings/', include('pass_collector_app.urls')),
